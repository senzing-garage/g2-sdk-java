...
/**
 * Defines the Java interface to the G2 diagnostic functions. The G2 diagnostic functions provide
 * diagnostics and statistics pertaining to the host system and the Senzing repository.
 */
interface NativeDiagnostic extends NativeApi {
  /**
   * Initializes the G2 Diagnostic object with the specified module name, init parameters and flag
  ...
  /**
   * Initializes the G2 Diagnostic object with the module name, initialization parameters, verbose
  ...
  /**
   * Gathers database information and writes detail of the result as JSON in the specified {@link
   * StringBuffer}.
   *
   * @param response The {@link StringBuffer} in which to write the JSON text that details the
   *     databse information.
   * @return Zero (0) on success and non-zero on failure.
   */
  ...
  /**
   * Runs non-destruction DB performance tests and writes detail of the result as JSON in the
  ...
  /**
   * Purges all data in the configured repository WARNING: There is no undoing from this. Make sure
   * your repository is regularly backed up.
   *
   * @return Zero (0) on success and non-zero on failure.
   */
  int purgeRepository();
   ...
   * @param response The {@link StringBuffer} to write the JSON result document to.
   * @return Zero (0) on success and non-zero on failure.
   */
