...
/**
 * The package-protected implementation of {@link SzEngine} that works with the {@link
...
public class SzCoreEngine implements SzEngine {
  ...
  /**
   * The empty response for operations where the info can optionally generated but was not
   * requested.
   */
   ...
   */
  SzCoreEngine(SzCoreEnvironment environment) throws IllegalStateException, SzException {
    ...
    this.env.execute(
        () -> {
          ...
          if (this.env.getConfigId() == null) {
            ...
            int returnCode =
                this.nativeApi.initWithConfigID(
                    this.env.getInstanceName(),
                    this.env.getSettings(),
    ...
    return this.env.execute(
        () -> {
          ...
          if (downstreamFlags == 0L && !flags.contains(SZ_WITH_INFO)) {
            ...
            returnCode = this.nativeApi.addRecord(dataSourceCode, recordId, recordDefinition);

          } else {
            // we either need info or have flags or both
            StringBuffer sb = new StringBuffer();
            returnCode =
                this.nativeApi.addRecordWithInfo(
                    dataSourceCode, recordId, recordDefinition, downstreamFlags, sb);
          ...
          if (returnCode != 0) {
            this.env.handleReturnCode(
                ...
                paramsOf(
                    ...
                    recordId,
                    "recordDefinition",
                    redact(recordDefinition),
                    "flags",
                    SzFlag.toString(flags),
                    "[downstreamFlags]",
  ...
  public String addRecord(SzRecordKey recordKey, String recordDefinition, Set<SzFlag> flags)
    ...
    return this.addRecord(
        recordKey.dataSourceCode(), recordKey.recordId(), recordDefinition, flags);
  }
  ...
  public long countRedoRecords() throws SzException {
    return this.env.execute(
        () -> {
          ...
          if (count < 0) {
            this.env.handleReturnCode(
                (int) count, this.nativeApi, CLASS_PREFIX + ".countRedoRecords()");
          }
  ...
  @Override
  public String deleteRecord(String dataSourceCode, String recordId, Set<SzFlag> flags)
    ...
    return this.env.execute(
        () -> {
          ...
          if (downstreamFlags == 0L && !flags.contains(SZ_WITH_INFO)) {
            // no info needed, no flags to pass, go simple
            returnCode = this.nativeApi.deleteRecord(dataSourceCode, recordId);

          } else {
            // we either need info or have flags or both
            StringBuffer sb = new StringBuffer();
            returnCode =
                this.nativeApi.deleteRecordWithInfo(dataSourceCode, recordId, downstreamFlags, sb);
  ...
  public String deleteRecord(SzRecordKey recordKey, Set<SzFlag> flags)
      throws SzUnknownDataSourceException, SzException {
    return this.deleteRecord(recordKey.dataSourceCode(), recordKey.recordId(), flags);
  }
  ...
  public long exportCsvEntityReport(String csvColumnList, Set<SzFlag> flags) throws SzException {
    ...
    return this.env.execute(
        () -> {
          ...
          int returnCode =
              this.nativeApi.exportCSVEntityReport(csvColumnList, downstreamFlags, result);
  ...
  public long exportJsonEntityReport(Set<SzFlag> flags) throws SzException {
    ...
    return this.env.execute(
        () -> {
          ...
          int returnCode = this.nativeApi.exportJSONEntityReport(downstreamFlags, result);
  ...
  /**
   * Encodes the {@link Set} of {@link Long} entity ID's as JSON. The JSON is formatted as:
   *
   * <pre>
   *   {
   *     "ENTITIES": [
   ...
   * </pre>
   *
   * @param entityIds The non-null {@link Set} of non-null {@link Long} entity ID's.
  ...
  /**
   * Encodes the {@link Set} of {@link SzRecordKey} instances as JSON. The JSON is formatted as:
   *
   * <pre>
   *   {
   *     "RECORDS": [
   ...
   * </pre>
   *
   * @param recordKeys The non-null {@link Set} of non-null {@link SzRecordKey} instances.
  ...
  @Override
  public String findNetworkByEntityId(
      Set<Long> entityIds,
      int maxDegrees,
      int buildOutDegrees,
    ...
    return this.env.execute(
        () -> {
          ...
          int returnCode =
              this.nativeApi.findNetworkByEntityID(
                  jsonEntityIds,
                  maxDegrees,
                  buildOutDegrees,
                  buildOutMaxEntities,
  ...
  @Override
  public String findNetworkByRecordId(
    ...
    return this.env.execute(
        () -> {
          ...
          int returnCode =
              this.nativeApi.findNetworkByRecordID(
                  jsonRecordKeys,
                  maxDegrees,
                  buildOutDegrees,
                  buildOutMaxEntities,
  ...
  @Override
  public String findPathByEntityId(
      long startEntityId,
      long endEntityId,
      int maxDegrees,
      Set<Long> exclusions,
    ...
    return this.env.execute(
        () -> {
          ...
          if ((exclusions == null || exclusions.isEmpty())
            ...
            returnCode =
                this.nativeApi.findPathByEntityID(startEntityId, endEntityId, maxDegrees, sb);
            ...
            returnCode =
                this.nativeApi.findPathExcludingByEntityID(
            ...
            returnCode =
                this.nativeApi.findPathIncludingSourceByEntityID(
          ...
          if (returnCode != 0) {
            this.env.handleReturnCode(
                ...
                this.nativeApi,
                CLASS_PREFIX
                    + ".findPathByEntityId(long,long,int,Set<Long>,Set<String>,Set<SzFlag>)",
                paramsOf(
                    "startEntityId",
                    startEntityId,
                    "endEntityId",
  ...
  @Override
  public String findPathByRecordId(
    ...
    return this.env.execute(
        () -> {
          ...
          if ((exclusions == null || exclusions.isEmpty())
            ...
            // call the base function
            returnCode =
                this.nativeApi.findPathByRecordID(
                    startDataSourceCode,
                    startRecordId,
                    endDataSourceCode,
                    endRecordId,
            ...
            // call the variant with exclusions, but without required data sources
            returnCode =
                this.nativeApi.findPathExcludingByRecordID(
                    startDataSourceCode,
                    startRecordId,
                    endDataSourceCode,
                    endRecordId,
            ...
            // we have to call the full-blown variant of the function
            returnCode =
                this.nativeApi.findPathIncludingSourceByRecordID(
                    startDataSourceCode,
                    startRecordId,
                    endDataSourceCode,
                    endRecordId,
          ...
          if (returnCode != 0) {
            this.env.handleReturnCode(
                ...
                this.nativeApi,
                CLASS_PREFIX
                    + ".findPathByRecordId(String,String,String,String,int,Set<SzRecordKey>,Set<String>,Set<SzFlag>)",
                paramsOf(
                    "startDataSourceCode",
                    startDataSourceCode,
                    "startRecordId",
  ...
  public String findPathByRecordId(
      ...
      Set<SzFlag> flags)
      throws SzNotFoundException, SzUnknownDataSourceException, SzException {
    return this.findPathByRecordId(
  ...
  public String getEntity(long entityId, Set<SzFlag> flags)
    ...
    return this.env.execute(
        () -> {
          ...
          StringBuffer sb = new StringBuffer();
          int returnCode = this.nativeApi.getEntityByEntityID(entityId, downstreamFlags, sb);
  ...
  @Override
  public String getEntity(String dataSourceCode, String recordId, Set<SzFlag> flags)
      throws SzUnknownDataSourceException, SzNotFoundException, SzException {
    return this.env.execute(
        () -> {
          // clear out the SDK-specific flags
          ...
          StringBuffer sb = new StringBuffer();
          int returnCode =
              this.nativeApi.getEntityByRecordID(dataSourceCode, recordId, downstreamFlags, sb);
  ...
  public String getEntity(SzRecordKey recordKey, Set<SzFlag> flags)
      throws SzUnknownDataSourceException, SzNotFoundException, SzException {
    return this.getEntity(recordKey.dataSourceCode(), recordKey.recordId(), flags);
  }

  @Override
  public String getRecord(String dataSourceCode, String recordId, Set<SzFlag> flags)
      throws SzUnknownDataSourceException, SzNotFoundException, SzException {
    return this.env.execute(
        () -> {
          // clear out the SDK-specific flags
          ...
          // check if we have flags to pass downstream
          StringBuffer sb = new StringBuffer();
          int returnCode = this.nativeApi.getRecord(dataSourceCode, recordId, downstreamFlags, sb);
  ...
  public String getRecord(SzRecordKey recordKey, Set<SzFlag> flags)
      throws SzUnknownDataSourceException, SzNotFoundException, SzException {
    return this.getRecord(recordKey.dataSourceCode(), recordKey.recordId(), flags);
  }
  ...
  public String getRedoRecord() throws SzException {
    return this.env.execute(
        () -> {
          ...
          if (returnCode != 0) {
            this.env.handleReturnCode(
                returnCode, this.nativeApi, CLASS_PREFIX + ".getRedoRecord()");
          }
  ...
  public String getVirtualEntity(Set<SzRecordKey> recordKeys, Set<SzFlag> flags)
    ...
    return this.env.execute(
        () -> {
          ...
          StringBuffer sb = new StringBuffer();
          int returnCode =
              this.nativeApi.getVirtualEntityByRecordID(jsonRecordString, downstreamFlags, sb);
  ...
  public String howEntity(long entityId, Set<SzFlag> flags)
    ...
    return this.env.execute(
        () -> {
          ...
          // check if we have flags to pass downstream
          StringBuffer sb = new StringBuffer();
          int returnCode = this.nativeApi.howEntityByEntityID(entityId, downstreamFlags, sb);
  ...
  public void primeEngine() throws SzException {
    this.env.execute(
        () -> {
          ...
          // check the return code
          if (returnCode != 0) {
            this.env.handleReturnCode(returnCode, this.nativeApi, CLASS_PREFIX + ".primeEngine()");
          }
  ...
  public String reevaluateEntity(long entityId, Set<SzFlag> flags) throws SzException {
    return this.env.execute(
        () -> {
          ...
          if (!flags.contains(SZ_WITH_INFO)) {
            // no info needed, no flags to pass, go simple
            returnCode = this.nativeApi.reevaluateEntity(entityId, downstreamFlags);

          } else {
            // we either need info or have flags or both
            StringBuffer sb = new StringBuffer();
            returnCode = this.nativeApi.reevaluateEntityWithInfo(entityId, downstreamFlags, sb);
  ...
  @Override
  public String reevaluateRecord(String dataSourceCode, String recordId, Set<SzFlag> flags)
      throws SzUnknownDataSourceException, SzException {
    return this.env.execute(
        () -> {
          // clear out the SDK-specific flags
          ...
          if (!flags.contains(SZ_WITH_INFO)) {
            // no info needed, no flags to pass, go simple
            returnCode = this.nativeApi.reevaluateRecord(dataSourceCode, recordId, downstreamFlags);

          } else {
            // we either need info or have flags or both
            StringBuffer sb = new StringBuffer();
            returnCode =
                this.nativeApi.reevaluateRecordWithInfo(
  ...
  public String reevaluateRecord(SzRecordKey recordKey, Set<SzFlag> flags)
      throws SzUnknownDataSourceException, SzException {
    return this.reevaluateRecord(recordKey.dataSourceCode(), recordKey.recordId(), flags);
  }

  @Override
  public String searchByAttributes(String attributes, String searchProfile, Set<SzFlag> flags)
      throws SzException {
    return this.env.execute(
        () -> {
          // clear out the SDK-specific flags
          ...
          if (searchProfile == null) {
            ...
            returnCode = this.nativeApi.searchByAttributes(attributes, downstreamFlags, sb);

          } else {
            returnCode =
                this.nativeApi.searchByAttributes(attributes, searchProfile, downstreamFlags, sb);
          }
  ...
  public String whyEntities(long entityId1, long entityId2, Set<SzFlag> flags)
    ...
    return this.env.execute(
        () -> {
          ...
          // check if we have flags to pass downstream
          StringBuffer sb = new StringBuffer();
          int returnCode = this.nativeApi.whyEntities(entityId1, entityId2, downstreamFlags, sb);
  ...
  @Override
  public String whyRecordInEntity(String dataSourceCode, String recordId, Set<SzFlag> flags)
      throws SzUnknownDataSourceException, SzNotFoundException, SzException {
    return this.env.execute(
        () -> {
          // clear out the SDK-specific flags
          ...
          StringBuffer sb = new StringBuffer();
          int returnCode =
              this.nativeApi.whyRecordInEntity(dataSourceCode, recordId, downstreamFlags, sb);
  ...
  public String whyRecordInEntity(SzRecordKey recordKey, Set<SzFlag> flags)
      throws SzUnknownDataSourceException, SzNotFoundException, SzException {
    return this.whyRecordInEntity(recordKey.dataSourceCode(), recordKey.recordId(), flags);
  }
  ...
  public String whyRecords(
    ...
    return this.env.execute(
        () -> {
          ...
          StringBuffer sb = new StringBuffer();
          int returnCode =
              this.nativeApi.whyRecords(
                  dataSourceCode1, recordId1, dataSourceCode2, recordId2, downstreamFlags, sb);
