...
/**
 * Implements the {@link NativeProduct} interface to call the native implementations of each
 * function.
 */
public class G2ProductJNI implements NativeProduct {
  ...
  /** {@inheritDoc} */
  @Override
  public native int validateLicenseStringBase64(String licenseData, StringBuffer errorResponse);
