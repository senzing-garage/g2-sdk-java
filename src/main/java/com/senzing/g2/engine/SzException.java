...
/**
 * Defines the base exception for Senzing errors. This adds a property for the numeric Senzing error
 * code which can optionally be set.
 */
public class SzException extends Exception {
  /**
   * Set this environment variable to the value <code>"true"</code> (case insensitive) to
   * <b>override</b> the default behavior of the {@link #redact(Object)} function of
   * <b>attempting</b> to redact sensitive data from the generated exception messages. Setting this
   * environment variable will <b>not</b> disable redaction if redaction has been explicitly enabled
   * programmatically via the {@link #enableRedaction()} function.
   *
   * <p><b>WARNING:</b> The Senzing SDK will use the {@link #redact(Object)} function to
   * <b>attempt</b> to redact sensitive data from exception messages, but this is <b>NOT</b> a
   * guarantee that all sensitive data will be redacted. The developer is still responsible to scrub
   * and redact sensitive data from messages to prevent exposing sensitive data to unauthorized
   * viewers (e.g.: in error dialogs of user interfaces or in system logs).
   *
   * @see #enableRedaction()
  ...
  /**
   * The {@link Map} of {@link String} parameter name keys to {@link Object} parameter name values.
   */
   ...
   */
  public SzException(String message, String methodSignature, Map<String, Object> methodParameters) {
    super(message);
  ...
  public SzException(
    ...
    this.methodSignature = methodSignature;
    this.methodParameters =
        (methodParameters instanceof ParameterMap)
            ? methodParameters
            : new ParameterMap(new LinkedHashMap<>(methodParameters));
  }
  ...
  /**
   * Gets the underlying Senzing error code associated with the exception. This returns <code>null
   * </code> if no error code was associated with the exception.
   *
   * @return The underlying Senzing error code associated with the exception, or <code>null</code>
  ...
  /**
   * Gets the description of the method signature of the method that failed causing this exception
   * to be generated. This method returns <code>null</code> if the method signature was not
   * specified when this instance was constructed.
   *
   * @return The description of the method signature of the method that failed causing this
   *     exception to be generated, or <code>null</code> if the method signature was not specified
  ...
  /**
   * Gets the <b>unmodifiable</b> {@link Map} describing the parameters used to call the method that
   * failed causing this exception to be generated. This method returns <code>null</code> if the
   * method parameters were not specified when this instance was constructed.
   *
   * @return Gets the <b>unmodifiable</b> {@link Map} describing the parameters used to call the
   *     method that failed causing this exception to be generated, or <code>null</code> if the
   *     method parameters were not specified when this instance was constructed.
   */
  ...
  /**
   * Handles optionally redacting the specified data to attempt to prevent inclusion of sensitive
   * data in a message that might be exposed.
   *
   * @param sensitiveData The potentially sensitive data to include in the exception message.
   * @return The redacted data or the specified object converted to a {@link String}.
   */
  ...
  /**
   * Utility method for adding parameter name/value pairs to the specified {@link LinkedHashMap}
   * while properly handling <code>null</code> keys and duplicate keys with suffixes.
   *
   * @param name The parameter name key.
   * @param value The parameter value.
   */
  private static void put(LinkedHashMap<String, Object> map, String name, Object value) {
  ...
  /**
   * Creates an unmodifiable <b>empty</b> {@link LinkedHashMap} with no entries for constructing
   * {@link SzException} instances with no parameters.
   *
   * @return A new unmodifiable <b>empty</b> {@link Map} representing no parameter name/value pairs.
   */
  ...
  /**
   * Creates an unmodifiable <b>ordered</b> {@link LinkedHashMap} representing the specified
   * parameters for helping with construction of {@link SzException} instances. If the value
   * contains sensitive data then {@link #redact(Object)} should be called with the result from that
   * function being passed instead.
   *
   * <p><b>NOTE:</b> If the parameter name is <code>null</code> then it is represented as <code>
   * "null"</code>. This is done to avoid throwing an exception while trying to construct an {@link
   * SzException}.
   *
   * @param name The name of the parameter.
   * @param value The value (or redacted value) for the parameter.
   * @return A new unmodifiable <b>ordered</b> {@link Map} containing the specified parameter name
   *     and parameter value.
   */
  ...
  /**
   * Creates an unmodifiable <b>ordered</b> {@link LinkedHashMap} representing the specified
   * parameters in the order they are specified. This is for helping with construction of {@link
   * SzException} instances. If a value contains sensitive data then {@link #redact(Object)} should
   * be called with the result from that function being passed instead.
   *
   * <p><b>NOTE:</b> Any <code>null</code> parameter names are represented as <code>"null"</code>.
   * Any duplicate keys are handled by suffixing them to make them unique. This is done to avoid
   * throwing an exception while trying to construct an {@link SzException}.
   *
   ...
   * @return A new unmodifiable <b>ordered</b> {@link Map} containing the specified parameter names
   *     matched to their respective parameter values.
   */
  public static Map<String, Object> paramsOf(
  ...
  /**
   * Provides a private unmodifiable {@link Map} implementation that can be typed-check to know if
   * the incoming {@link Map} of parameters needs to be copied or if it can be used as-is.
   */
  private static class ParameterMap extends AbstractMap<String, Object> {
    ...
    /** Constructs with the specified {@link LinkedHashMap} of parameter name/value pairs. */
