...
/**
 * Describes an exceptional condition when an attempt is made to replace a Senzing value with a new
 * value providing it has not not already been changed, however, the current value is no longer the
 * expected value and has therefore already been changed.
 */
