...
/**
 * Defines the Java interface to the G2 product functions. The G2 product functions provide
 * information regarding the Senzing product installation and user license.
 */
interface NativeProduct extends NativeApi {
  /**
   * Initializes the G2 product API with the specified module name, init parameters and flag
   ...
   * @param errorResponse The {@link StringBuffer} to write any error response to (if an error
   *     occurs).
   * @return Zero (0) for valid license, one (1) for invalid, and a negative number for errors.
   */
