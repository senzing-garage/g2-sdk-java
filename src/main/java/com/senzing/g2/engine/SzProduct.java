...
/**
 * Defines the Java interface to the Senzing product functions. The Senzing product functions
 * provide information regarding the Senzing product installation and user license.
 */
