...
public class RepeatedOptionException extends CommandLineException {
  ...
  /**
   * Constructs with the {@link CommandLineOption} that was repeated and the flags used to specify
   * it. This is constructed with a {@link Set} of flags that were used in case the same option can
   * be specified with synonym flags.
   *
  ...
  /**
   * Returns the <b>unmodifiable</b> {@link Set} of command-line flags used to specify the repeated
   * {@link CommandLineOption}.
   *
   * @return The <b>unmodifiable</b> {@link Set} of command-line flags used to specify the repeated
   *     {@link CommandLineOption}.
   */
   ...
   * @param flags The {@link Set} of {@link String} command-line flags that were specified.
   * @return The formatted error message.
   * @throws NullPointerException If either of the specified parameters is <code>null</code>.
   * @throws IllegalArgumentException If the specified {@link Set} is empty.
   */
  public static String buildErrorMessage(CommandLineOption option, Set<String> flags)
