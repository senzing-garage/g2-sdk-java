...
/**
 * Provides an abstract base class for exceptions pertaining to a specific specified option.
 * Exceptions that extend this class implement the {@link SpecifiedOption} interface.
 */
public abstract class SpecifiedOptionException extends CommandLineException
   ...
   */
  protected SpecifiedOptionException(
   ...
   */
  protected SpecifiedOptionException(
      CommandLineSource source, CommandLineOption option, String specifier, String message) {
    super(message);
    this.source = source;
    this.specifier = specifier;
    this.option = option;
  ...
  /**
   * Gets the {@link CommandLineOption} that programmatically identifies the option.
   *
   * @return The {@link CommandLineOption} that programmatically identifies the option.
   */
  @Override
