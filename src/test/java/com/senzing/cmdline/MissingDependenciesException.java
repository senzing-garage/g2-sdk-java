...
/**
 * Thrown when a command-line argument is specified without the required dependencies for that
 * argument.
 */
public class MissingDependenciesException extends SpecifiedOptionException {
   ...
   * @param specifiedOptions The {@link Set} of {@link CommandLineOption} instances that were
   *     specified.
   */
  ...
  public MissingDependenciesException(
    ...
    super(
        ...
        option,
        specifier,
        buildErrorMessage(source, option, option.getDependencies(), specifier, specifiedOptions));
  }
   ...
   * @param source The {@link CommandLineSource} describing how the option was specified.
   * @param option The {@link CommandLineOption} that was missing required parameters.
   * @param dependencySets The {@link Set} of {@link CommandLineOption} {@link Set} values
   *     representing the missing dependencies to report.
   * @param specifier The command-line flag or environment variable used to specify the option, or
   *     <code>null</code> if specified as a default value.
   * @param specifiedOptions The {@link Set} of {@link CommandLineOption} instances that were
   *     specified.
  ...
  public MissingDependenciesException(
    ...
    super(
        ...
        option,
        specifier,
        buildErrorMessage(source, option, dependencySets, specifier, specifiedOptions));
  }
   ...
   *     {@link Set} of specified {@link CommandLineOption} instances is <code>null</code>.
   */
