...
/**
 * Implemented by classes that describe an option that was specified via a specific {@link
...
public interface SpecifiedOption {
  ...
  /**
   * Returns a descriptor for the source of the specified option for building user messages.
   *
   * @return A descriptor for the source of the specified option for building user messages.
   */
  default String getSourceDescriptor() {
    return sourceDescriptor(this.getSource(), this.getOption(), this.getSpecifier());
  }

  /**
   * Utility method for building the {@linkplain #getSourceDescriptor() source descriptor} from the
   * {@link CommandLineSource}, specifier and {@link CommandLineOption}.
   *
   ...
   * @return A descriptor for the source of the specified option for building user messages.
   */
  static String sourceDescriptor(
