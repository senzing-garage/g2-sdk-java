...
public class SzRecord {
  ...
  public record SzFullName(String fullName, String nameType) implements SzName {
  ...
  public record SzNameByParts(String firstName, String lastName, String nameType)
      implements SzName {
    public static SzNameByParts of(String firstName, String lastName) {
      return new SzNameByParts(firstName, lastName, null);
    }

    public static SzNameByParts of(String firstName, String lastName, String nameType) {
  ...
  public record SzAddressByParts(
    ...
    public static SzAddressByParts of(
        String street, String city, String state, String postalCode, String addressType) {
  ...
  public record SzPhoneNumber(String phone, String phoneType) implements SzRecordData {
  ...
  public record SzEmailAddress(String email, String emailType) implements SzRecordData {
    public String getPluralName() {
      return "EMAILS";
    }
  ...
  public record SzDriversLicense(String licenseNumber, String state) implements SzRecordData {
  ...
  public record SzPassport(String passportNumber, String country) implements SzRecordData {
  ...
  public SzRecord(SzRecordKey key, SzRecord other) {
    ...
    if (this.recordKey == null) {
      ...
      this.dataMap.put(
          SzDataSourceCode.class, List.of(SzDataSourceCode.of(recordKey.dataSourceCode())));
      this.dataMap.put(SzRecordId.class, List.of(SzRecordId.of(recordKey.recordId())));
    }
  }
      ...
      for (SzRecordData data : recordData) {
        ...
        if (list.size() > 0 && pluralName == null) {
          throw new IllegalArgumentException(
              "Multiple values for "
                  + classKey.getSimpleName()
                  + " are not allowed.  specified=[ "
                  + data
                  + "], existing=[ "
                  + list.get(0)
                  + " ]");
